 ...
 *
 * 🎯 MISSION
 * Créez une fonction sontEgaux(tab1, tab2) qui vérifie si deux tableaux contiennent 
 * exactement les mêmes éléments dans le même ordre. (Rappel: [1] == [1] donne false en JS !).
 *
