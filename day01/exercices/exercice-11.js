...
const coûtFinal  = panier - remise + (livraisonGratuite ? 0 : livraison)

console.log("finalPanier: " + coûtFinal + " MAD")
console.log(`livraison gratuite: ${livraisonGratuite ? "yes" : "no"} `)