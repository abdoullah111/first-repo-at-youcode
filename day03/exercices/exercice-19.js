 ...
 *
 * 🎯 MISSION
 * Bien que ce ne soit pas spécifique au DOM, utilisez la fonction native setTimeout(callback, delai) 
 * pour créer une fonction alarme(message, secondes) qui affichera le message après X secondes.
 *
...
function alarme(message, secondes) {
  let callback = function(){console.log(message)}
