 ...
 *
 * 🎯 MISSION
 * Créez un objet compteBancaire avec une propriété solde et une méthode deposer(montant).
 *  La méthode doit utiliser this.solde pour augmenter le solde actuel.
 *
...
console.log(compteBancaire.deposer(50))
